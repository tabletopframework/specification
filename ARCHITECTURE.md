...
| `Движок` | Представление текущего состояния. Включает физические компоненты: игровые поля/планшеты, воины/фишки, здания/жетоны/предметы и кубы. Исполняется участником в свой ход. |
